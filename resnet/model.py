from keras import layers, Model, Sequential, regularizers
...
def _resnet(block, blocks_num, im_width=224, im_height=224, num_classes=100, include_top=True):
...
def resnet50(im_width=224, im_height=224, num_classes=100, include_top=True):
